...
{
    public async Task<FinishedProductWithoutOrdersDomain?> GetFinishedProductByNameWithoutOrders(string finishedProductName, CancellationToken cancellationToken)
    {

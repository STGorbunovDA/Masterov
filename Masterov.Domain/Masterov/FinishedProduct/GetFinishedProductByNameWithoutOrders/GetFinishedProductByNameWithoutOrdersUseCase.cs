...
{
    public async Task<IEnumerable<FinishedProductWithoutOrdersDomain?>> Execute(GetFinishedProductByNameWithoutOrdersQuery getFinishedProductByNameQuery, CancellationToken cancellationToken)
    {

...
{
    public async Task<IEnumerable<FinishedProductNoOrdersDomain?>> Execute(GetFinishedProductByNameWithoutOrdersQuery getFinishedProductByNameQuery, CancellationToken cancellationToken)
    {

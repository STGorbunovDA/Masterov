...
public class GetFinishedProductByOrderIdUseCase(IValidator<GetFinishedProductByOrderIdQuery> validator, IGetFinishedProductByOrderIdStorage orderIdStorage, IGetOrderByOrderIdStorage getOrderByOrderIdStorage) : IGetFinishedProductByOrderIdUseCase
{
    public async Task<FinishedProductDomain?> Execute(GetFinishedProductByOrderIdQuery getFinishedProductByOrderIdQuery, CancellationToken cancellationToken)
    {
        ...
        var productionOrderExists = await getOrderByOrderIdStorage.GetOrderByOrderId(getFinishedProductByOrderIdQuery.OrderId, cancellationToken);
